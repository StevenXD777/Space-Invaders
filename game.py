...
class Game:
    def __init__(self, screen_width, screen_height, offset):
        ...
        # Monitor spaceship by making a dedicated group for this sprite
        self.spaceship_group = pygame.sprite.GroupSingle()
        self.spaceship_group.add(Spaceship(self.screen_width, self.screen_height, self.offset))

        # Creating obstacles in game
        self.obstacles = self.create_obstacles()

        # Creating aliens in game
        self.aliens_group = pygame.sprite.Group()
        self.create_aliens()
        self.aliens_direction = 1
        self.alien_lasers_group = pygame.sprite.Group()

        # Creating Mystery Ship at the top of the screen
        ...
        pygame.mixer_music.load("Sound/60. Guile's Theme [CPS-2].mp3")
        ...
        # Button Sound
        self.select_sound = pygame.mixer.Sound("Sound/button-124476.mp3")
